...
public class ResolucaoTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Exitfullscreen_screen_output_1900.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("Resolução da Tela");

        lblResolucao.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblResolucao.setText("Clique no botão para ver a resolução");
    ...
    private void btnResolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResolucaoActionPerformed
        ...
        int b = (int) tk.getWidth();
        int h = (int) tk.getHeight();
        lblResolucao.setText(b + " x " + h);
    ...
    private int toString(int width) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private char toChar(int width) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
